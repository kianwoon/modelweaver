...
// Removed: sanitizeSSEChunk and shouldDropNullDelta tests.
// Both functions were removed from proxy.ts in the pure passthrough change.
// The proxy now forwards bytes untouched — null sanitization is no longer needed.
